...
need to find a way to determine which list contains the access codes once you're
ready to go in. 
...
where x divides y and y divides z, such as (1, 2, 4). With that information, you
can figure out which list contains the number of access codes that matches the
