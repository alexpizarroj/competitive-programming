  ...
  if compilation_cmd[0] != "":
    ...
    with open(errlog_filepath, "wb") as log:
      try:
        ...
        fail_msg = "Error al buscar/ejecutar '%s'" % (compilation_cmd[0])
...
if __name__ == "__main__":
  ...
  # sample_folder = os.path.join(base_data_folder, "secret")
  secret_folder = os.path.join(base_data_folder, "secret")
  ...
  def do_output_matching_tests(data_folder):
    ...
    for fn in os.listdir(data_folder):
      ...
      output_fp = input_fp[:-3] + ".sol"
      modelout_fp = input_fp[:-3] + ".main.sol"
      modelerr_fp = input_fp[:-3] + ".main.err"
